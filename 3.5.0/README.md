...
**Note:** CouchDB 3.x requires admin credentials. The container will fail to start without `COUCHDB_USER` and `COUCHDB_PASS` environment variables.
...
- `COUCHDB_PASS` - Admin password (required)
